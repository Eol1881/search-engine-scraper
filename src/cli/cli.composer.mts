...
import { buildPuppeteerGetPageContent, type PuppeteerConfig } from "../playwright/playwright.get-page-content.mts";
...
export const buildCli = (config: CliConfig) => {
  ...
  const getSearchPageHtml = buildPuppeteerGetSearchPageHtml(getYandexUrl, getPageContent);
